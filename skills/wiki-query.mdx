...
description: "Synthesized answers from your ingested wiki — hot cache first, then index, then pages. Every answer cites specific vault pages, not model training data."
---
