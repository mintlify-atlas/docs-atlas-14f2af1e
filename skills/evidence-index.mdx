...
description: "Index security audit artifacts with SHA256 checksums into a tamper-evident chain of custody. Writes to evidence-index.md and evidence-manifest.json only."
---
