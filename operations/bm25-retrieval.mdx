...
description: "Bunker OS includes a zero-dependency BM25 search implementation in pure Python stdlib — index your wiki, search it offline, and let OpenCode synthesize the answers."
---
