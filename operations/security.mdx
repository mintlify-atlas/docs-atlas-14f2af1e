...
description: "Bunker OS's security model covers secrets management, URL validation in autoresearch, local binding, dry-run defaults, and OWASP-aligned MCP governance practices."
---
