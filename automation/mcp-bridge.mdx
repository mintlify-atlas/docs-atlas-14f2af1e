...
description: "Set up n8n-mcp and obsidian-vault MCP servers in opencode.json so OpenCode skills can trigger async n8n pipelines and read/write vault notes directly."
---
...
<CardGroup cols={2}>
  <Card title="obsidian-vault" icon="vault" href="/skills/autoresearch">
  ...
  <Card title="n8n-mcp" icon="plug" href="/automation/n8n-overview">
...
Add the `obsidian-vault` block to `~/.config/opencode/opencode.json`:
