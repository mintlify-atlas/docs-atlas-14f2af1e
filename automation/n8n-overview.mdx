...
description: "n8n acts as Bunker OS's async execution engine — handling webhooks, AI triage, GitHub integration, error handling, and multi-channel alerts on local Docker."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Complexity" icon="code-branch">
