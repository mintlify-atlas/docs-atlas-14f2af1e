...
description: "The Dead Letter Queue is a global n8n error trigger that catches failures from every workflow, classifies severity, and persists up to 200 errors for review and replay."
---
