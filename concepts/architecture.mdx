...
<CardGroup cols={2}>
  <Card title="Layer 1 — Capture" icon="inbox" href="concepts/vault-structure">
  ...
  <Card title="Layer 2 — Normalize" icon="wand-magic-sparkles" href="skills/wiki-ingest">
  ...
  <Card title="Layer 3 — Classify" icon="tags" href="concepts/vault-structure">
  ...
  <Card title="Layer 4 — Evidence" icon="shield-check" href="skills/evidence-index">
  ...
  <Card title="Layer 5 — Governance" icon="scale-balanced" href="concepts/architecture">
  ...
  <Card title="Layer 6 — Automation" icon="robot" href="automation/n8n-overview">
  ...
  <Card title="Layer 7 — Retrieval" icon="magnifying-glass" href="operations/bm25-retrieval">
  ...
  <Card title="Layer 8 — Testing" icon="flask" href="operations/testing">
  ...
  <Card title="Layer 9 — Agent Runtime" icon="microchip" href="skills/overview">
    13 bundled OpenCode skills, slash command definitions, 3 agent instruction files, and 7 hooks across 4 lifecycle events.
  </Card>
  <Card title="Layer 10 — Visualization" icon="chart-bar" href="concepts/local-first">
